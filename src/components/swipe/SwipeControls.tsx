  ...
  return (
    <div className="flex flex-col items-center gap-4">
      ...
      <div className="flex items-center justify-center gap-12">
        ...
        >
          <div className="relative w-24 h-24 rounded-full bg-gradient-to-br from-uw-purple to-purple-700 shadow-lg hover:shadow-2xl transition-all duration-200 hover:scale-110 active:scale-95 hover:from-purple-600 hover:to-purple-800">
            <div className="absolute inset-0 rounded-full bg-white/20 opacity-0 group-hover:opacity-100 transition-opacity" />
            <Heart className="absolute inset-0 m-auto w-12 h-12 text-white fill-white" strokeWidth={0} />
          </div>
